...
namespace C3P1.Services.Admin
{
    public class ManageUserServerService : IManageUserService
    {
        private readonly AppDbContext _context;
        private readonly UserManager<AppUser> _userManager;
        public ManageUserServerService(AppDbContext context, UserManager<AppUser> userManager)
        {
            _context = context;
